"""
Shared helpers for WhisNemo pipeline.
Ported from whisper-diarization/helpers.py with your exact config values.
"""
...
TO_LANGUAGE_CODE = {
    **{language.title(): code for code, language in LANGUAGES.items()},
    "burmese": "my",
    "valencian": "ca",
    "flemish": "nl",
    "haitian": "ht",
...
def _get_config_dir():
    """
    Return the nemo_msdd_configs directory.
    Uses the 'configs' dir bundled with this package.
    """
